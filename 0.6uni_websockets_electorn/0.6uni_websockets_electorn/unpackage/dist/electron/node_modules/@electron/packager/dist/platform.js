...
class App {
    ...
    async normalizeIconExtension(targetExt) {
        ...
        /* istanbul ignore next */
        (0, common_1.warning)(`Could not find icon "${this.opts.icon}" with extension "${targetExt}", skipping this app icon format`, this.opts.quiet);
    }
    ...
    async copyPrebuiltAsar() {
        ...
        await fs_extra_1.default.copy(src, this.appAsarPath, {
            overwrite: false,
            errorOnExist: true,
        });
    }
