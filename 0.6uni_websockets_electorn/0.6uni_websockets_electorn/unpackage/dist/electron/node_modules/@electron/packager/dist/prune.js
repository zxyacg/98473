...
function isNodeModuleFolder(pathToCheck) {
    return (path_1.default.basename(path_1.default.dirname(pathToCheck)) === 'node_modules' ||
        (path_1.default.basename(path_1.default.dirname(pathToCheck)).startsWith('@') &&
            path_1.default.basename(path_1.default.resolve(pathToCheck, `..${path_1.default.sep}..`)) ===
                'node_modules'));
}
async function isModule(pathToCheck) {
    return ((await fs_extra_1.default.pathExists(path_1.default.join(pathToCheck, 'package.json'))) &&
